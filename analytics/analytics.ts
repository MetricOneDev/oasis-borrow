...
export const trackingEvents = {
  ...
  // First Confirm button when the user is on MONE and type into Generate
  ...
  // Confirm button when the user is on MONE and type into Payback
