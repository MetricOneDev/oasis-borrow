...
const tokens = [
  ...
  },
  {
    ...
    maxSell: '10000000',
    name: 'Astro Swap',
    icon: 'astro_circle_color',
    iconCircle: 'astro_circle_color',
    iconColor: 'astro_circle_color',
    ticker: 'eth-ethereum',
    coinbaseTicker: 'eth-usdc',
    color: '#667FE3',
    background:
  ...
  },
  {
    ...
    digits: 5,
    name: 'Binance Coin',
    icon: 'bnb_circle_color',
    iconCircle: 'bnb_circle_color',
    iconColor: 'bnb_circle_color',
    color: '#ff4625',
  ...
  },
  {
    ...
    digits: 5,
    name: 'Fantom Coin',
    icon: 'ftm_circle_color',
    iconCircle: 'ftm_circle_color',
    iconColor: 'ftm_circle_color',
    color: '#ff4625',
    background: 'linear-gradient(133.6deg, #F75E18 21.52%, #F48C5C 98.44%)',
    bannerIcon: staticFilesRuntimeUrl('/static/img/banner_icons/bat.svg'),
    tags: [],
  ...
  },
  {
    ...
    name: 'Binance USD',
    icon: 'busd',
    iconCircle: 'busd_circle_color',
    iconColor: 'busd_circle_color',
    color: '259c77',
    background: 'linear-gradient(152.36deg, #25A680 17.19%, #66C5A9 95.07%)',
    bannerIcon: staticFilesRuntimeUrl('/static/img/banner_icons/usdt.svg'),
    tags: ['stablecoin'],
