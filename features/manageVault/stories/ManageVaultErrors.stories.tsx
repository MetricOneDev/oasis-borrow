...
export const GenerateAndPaybackAmountsEmpty = manageVaultStory({
  title:
    'If both the generate and payback input fields are empty when editing "MONE" then we disable the progress button and suggest user to enter an amount',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('100'),
    debt: new BigNumber('3000'),
...
export const PaybackEmpty = manageVaultStory({
  title:
    'Similar to PaybackAndWithdrawAmountsEmpty only that the connected user is not the controller of the vault. At the "MONE" editing stage they would only be able payback so we block the flow if no payback amount is set',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('100'),
    debt: new BigNumber('3000'),
...
export const GenerateAmountExceedsStblYieldFromTotalCollateral = manageVaultStory({
  title:
    'Error is shown when a user is trying to generate an amount of MONE that is greater than the maximum of stbl that can be generated from the collateral already locked in the vault and the amount of collateral the user is also depositing',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('15'),
    debt: new BigNumber('3000'),
...
export const GenerateAmountExceedsStblYieldFromTotalCollateralAtNextPrice = manageVaultStory({
  title:
    'Error is shown when a user is trying to generate an amount of MONE that is greater than the maximum of stbl at next price update that can be generated from the collateral already locked in the vault and the amount of collateral the user is also depositing',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('15'),
...
export const GenerateAmountLessThanDebtFloor = manageVaultStory({
  title:
    'Error is shown when a user is generating an amount of MONE that would cause the debt outstanding in the vault to be less than the dust limit/debt floor. In more detail, if this vault has a debt of 1999 MONE and the dust limit was 2000 MONE, were the user to generate 1 MONE, then they could proceed',
  vault: {
    ilk: 'WBTC-A',
...
export const DepositToVaultUnderDebtFloor = manageVaultStory({
  title:
    'Error is shown when a user is trying to deposit more collateral on a vault that is under debt floor. In this case user should first either payback all debt in order to withdraw any collateral or by depositing more collateral in order to generate this additional MONE - which must be done in the same transaction.',
  vault: {
    ilk: 'MTR-A',
...
export const PaybackAmountExceedsStblBalance = manageVaultStory({
  title: 'Error occurs when user is trying to pay back more MONE than they have in their wallet',
  vault: {
    ilk: 'WBTC-A',
...
export const PaybackAmountExceedsVaultDebt = manageVaultStory({
  title: 'Error occurs when the user tries to payback more MONE than exists as debt in their vault',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('100'),
    debt: new BigNumber('5000'),
...
export const PaybackAmountCausesVaultDebtToBeLessThanDebtFloor = manageVaultStory({
  title:
    'Error occurs when the user pays back an amount of MONE which would cause the remaining vault debt to be under the dust limit but not the full amount',
  vault: {
    ilk: 'WBTC-A',
    collateral: new BigNumber('100'),
    debt: new BigNumber('5000'),
...
export const DepositingAllCoinBalance = manageVaultStory({
  title: 'Error occurs when a user with an MTR vault tries to deposit all their MTR into the vault',
  vault: {
    ilk: 'MTR-A',
    collateral: new BigNumber('100'),
    debt: new BigNumber('5000'),
