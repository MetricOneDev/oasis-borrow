...
export const content: ContentTypeSupport = {
  title: 'FAQ',
  navigation: [
    { title: 'Utilizando vaults.metric.one', id: 'using-oasis' },
  ...
  sections: [
    {
      title: 'Utilizando vaults.metric.one',
      id: 'using-oasis',
      questions: [
        {
          question: 'Quais ativos posso usar como colateral?',
          answer: `Você pode usar os colaterais que são aprovados pela Governança do MetricOne, incluindo MTR e BTC envelopado ('wrapped BTC'). Você pode ver cada um dos tipos entrando no vaults.metric.one, podendo checar inclusive a Taxa de Estabilidade e Ratio Mínimo de Colateralização.`,
        },

        {
          question: 'Quanto custa?',
          answer: `Abrir e gerir um Cofre (Vault) é grátis no vaults.metric.one, exceto pelos custos com gás e Taxas de Estabilidade. A Taxa de Estabilidade é cobrada em cima da quantidade de MONE gerada e é destinada diretamente ao Protocolo MetricOne.`,
        },

        {
          question: 'Como eu abro um Cofre (Vault)',
          answer: `Para abrir um Cofre, selecione o colateral e seu sub-tipo (ex. MTR-A) na página inicial (vaults.metric.one), connecte sua carteira escolhida e siga as instruções.`,
        },

        {
          question: 'O que é a Taxa de Estabilidade?',
          answer: `A Taxa de Estabilidade é a taxa anual varíavel (mostrada em porcentagem) adicionada a sua dívida - que deverá ser paga. Ela pode ser vista como o custo para gerar MONE, que é pago diretamente ao Protocolo MetricOne.`,
        },
...

        {
          ...
          answer: `As permissões de tokens permitem você controlar quanto o contrato Proxy pode interagir em relação ao balanço de sua carteira. Isso permite que o Contrato Proxy pague MONE ou interaja com os colaterais em sua carteira. Você precisará autorizar a permissão ("allowance") para cada token que deseja utilizar no vaults.metric.one. Você pode configurar sua permisão ("allowance") para a quantia que você deseja usar cada vez ou para um valor maior, já pensando em futuras interações com vaults.metric.one. Isso será apresentado para você dentro dos fluxos do vaults.metric.one e você não terá que realizar ação alguma se você não encontrar avisos neste sentido.`,
        },
...

        {
          ...
          answer: `Gás é unidade de medida utilizada para pagar por transações no blockchain do Meter. Os preços de gás são cobrados em MTR e você sempre precisará ter MTR em sua carteira para ser capaz de interagir com vaults.metric.one. Essa taxa vai diretamente para os mineradores do Meter que mantém a rede do Meter funcionando. vaults.metric.one não cobra taxas pelo uso de funcionalidades básicas do Cofre.`,
        },
        ...
        {
          question: 'Como eu contato o time do MetricOne?',
          answer:
            'Se tiver alguma pergunta, nos [contate usando esta página](/stblwallet/contact) ou nos mande uma mensagem no [Twitter](https://twitter.com/MetricOne).',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        {
          question: 'Como posso contatar o time do MetricOne?',
          answer:
            'Se tiver alguma pergunta, nos [contate usando esta página](/stblwallet/contact) ou nos mande uma mensagem no [Twitter](https://twitter.com/MetricOne).',
        },
      ],
