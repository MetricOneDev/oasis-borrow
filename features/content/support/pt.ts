      ...
      questions: [
        {
          ...
          answer: `Você pode usar os colaterais que são aprovados pela Governança do MetricOne, incluindo MTR e BTC envelopado ('wrapped BTC'). Você pode ver cada um dos tipos entrando no oasis.app, podendo checar inclusive a Taxa de Estabilidade e Ratio Mínimo de Colateralização.`,
        },

        {
          question: 'Quanto custa?',
          answer: `Abrir e gerir um Cofre (Vault) é grátis no Oasis.app, exceto pelos custos com gás e Taxas de Estabilidade. A Taxa de Estabilidade é cobrada em cima da quantidade de MONE gerada e é destinada diretamente ao Protocolo MetricOne.`,
        },

        {
          question: 'Como eu abro um Cofre (Vault)',
          answer: `Para abrir um Cofre, selecione o colateral e seu sub-tipo (ex. MTR-A) na página inicial (oasis.app), connecte sua carteira escolhida e siga as instruções.`,
        },
...

        {
          ...
          answer:
            'Se tiver alguma pergunta, nos [contate usando esta página](/stblwallet/contact) ou nos mande uma mensagem no [Twitter](https://twitter.com/oasisdotapp).',
        },
      ],
    },
    {
