  ...
  sections: [
    {
      ...
      questions: [
        {
          question: 'What is Metric Vaults?',
          answer: `Metric Vaults is the home for everything you want to accomplish with MONE. A decentralized application that runs on the Meter blockchain, Metric Vaults enables you to Buy, Send, and Manage your MONE all in one place.`,
        },
        {
        ...
        },
        {
          ...
          answer: `No. You do not need to create a new account to use Metric Vaults. You can get started with almost any Meter wallet, including Metamask or Coinbase Wallet, or you can use our new Magic.Link feature -- where you provide an email address, click a link in the email we send you in response, and you're logged in.`,
        },
        {
          question: 'Will I be charged fees?',
          answer:
            'Metric Vaults is currently free to use. However, you will have to pay transaction fees and, depending on the features you use, fees associated with MetricOne and other protocols, such as Stability or exchange fees.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'If you have any questions, reach out to us through on [Twitter](https://twitter.com/).',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          question: 'Can I buy MONE while using Metric Vaults?',
        ...
        {
          question: 'Can I buy MTR on Metric Vaults to pay for my transaction fees?',
          answer:
