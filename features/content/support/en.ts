      ...
      questions: [
        {
          ...
          answer: `You can use many different collateral types which are voted in by MetricOne Governance to the MetricOne Protocol, including MTR and wrapped BTC. You can see each one by visiting oasis.app with the corresponding Stability Fees and Minimum Collateralization Ratios.`,
        },

        {
          question: 'How much does it cost?',
          answer: `Opening and managing a Vault is free on Oasis.app except for gas costs and Stability Fees. The Stability Fee is charged on the amount of MONE you have generated and goes directly to the MetricOne Protocol.`,
        },

        {
          question: 'How do I open a Vault?',
          answer: `To open a Vault, select the relevant Collateral and sub-type (e.g. MTR-A) from the homepage (Oasis.app) and connect your preferred wallet and follow the on screen instructions that will guide you through.`,
        },
...

        {
          ...
          answer: `Token allowances let you control how much the proxy contract can do with the token balance in your wallet. To allow the Proxy contract to pay back MONE, or interact with the collaterals in your wallet, you will need to authorize it by setting an allowance with each token that you want to use with Oasis.app. You can set the allowance to the amount you want to use each time or you can set a higher allowance for future interactions with Oasis.app. This will all be presented to you within the flows inside Oasis.app, and you won’t have to do anything extra if you don’t see any prompts.`,
        },
...

        {
          ...
          answer: `The minimum Vault Debt, also called Dust, is the minimum amount of MONE you must generate to open a new Vault, and maintain. This minimum Vault Debt value is set and can be adjusted at any time by MetricOne Governance. If the minimum is increased to a value above your current Debt, then you will experience reduced functionality of your Vault until you increase it to above the minimum again. Read more about minimum Vaul Debt [here](https://kb.oasis.app/help/minimum-vault-debt-dust).`,
        },
...

        {
          ...
          answer:
            'If you have any questions, reach out to us through our [Contact page](/stblwallet/contact) or on [Twitter](https://twitter.com/oasisdotapp).',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer: `MONE Wallet is the home for everything you want to accomplish with MONE. A decentralized application that runs on the Meter blockchain, Oasis MONE Wallet enables you to Buy, Send, and Manage your MONE all in one place.`,
        },
        {
