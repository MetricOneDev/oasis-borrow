  ...
  sections: [
      ...
      questions: [
        {
          ...
          answer: `Puedes utilizar muchos tipos diferentes de colateral incluyendo MTR y WBTC. Los colaterales son incorporados por el gobierno de MetricOne en el protocolo. Puedes ver cada uno visitando oasis.app con su correspondiente tasa de estabilidad y su ratio de colateralización mínimo.`,
        },
        {
          question: '¿Cuanto cuesta?',
          answer: `Abrir y administrar un Vault es gratis en Oasis.app. Pagarás el gas para las transacciones y la tasa de estabilidad. La tasa de estabilidad es cobrada sobre el MONE que has generado y va directamente al protocolo MetricOne.`,
        },
        {
          question: '¿Cómo abro un Vault? ',
          answer: `Para abrir un Vault, selecciona el colateral y el subtipo (ej. MTR-A) en la página principal (Oasis.app), conecta tu cartera preferida y sigue las instrucciones que te guiarán en el proceso.`,
        },
        {
        ...
        },
        {
          ...
          answer: `El gas es la unidad de medidas para pagar por las transacciones en la blockchain de Meter. Los precios del Gas se cobran en MTR y siempre necesitarás tener MTR en tu cartera para poder interactuar con Oasis.app. Esta tarifa de gas va directamente a los mineros de Meter que mantienen Meter corriendo. Oasis.app no cobra ninguna tarifa por el manejo básico de los Vaults.`,
        },
        {
        ...
        },
        {
          ...
          answer:
            'Si tienes preguntas, puedes comunicarte con nosotros a través de la [página de contacto](/stblwallet/contact) o en [Twitter](https://twitter.com/oasisdotapp).',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'MONE Wallet es el sitio para todo lo que quieras lograr con MONE. Una aplicación descentralizada que corre sobre la blockchain de Meter, Oasis MONE Wallet te permite comprar, enviar y administrar tu MONE, todo en un único lugar.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'No. No necesitas creas una cuenta nueva para usar Oasis.app Puedes comenzar con casi cualquier cartera de Meter como Metamask o Coinbase Wallet. También puedes utilizar la funcionalidad de Magic.link, con la cual ingresas una dirección de email, y con un solo click en el link que enviaremos a tu bandeja de entrada ya puedes ingresar.',
        },
        {
        ...
        },
        {
          question: '¿Cómo puedo contactar al equipo de Oasis?',
          answer:
            'Si tienes alguna pregunta contáctanos a través de nuestra [página de contacto](/stblwallet/contact) o en [Twitter](https://twitter.com/oasisdotapp).',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: '¿Puedo comprar MTR en Oasis para pagar por las tarifas de la red?',
          answer:
